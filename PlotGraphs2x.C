{
  ...
  TGraph *g2=(TGraph *)f.Get("Delta_IPM2H00_XPOS");
  TGraph *g3=(TGraph *)f.Get("Delta_IPM2H01_XPOS");
  TGraph *g4=(TGraph *)f.Get("Delta_IPM2H02_XPOS");
  TGraph *g_t=(TGraph *)f.Get("HPS_T");
  TGraph *g5 = new TGraph(*g_t);
  TGraph *g_sc=(TGraph *)f.Get("HPS_SC");
  TGraph *g6 = new TGraph(*g_sc);
  TGraph *g7=(TGraph *)f.Get("Delta_IPM2C21A_XPOS");
  TGraph *g8=(TGraph *)f.Get("Delta_IPM2C24A_XPOS");
  ...
  TLatex *t2 = new TLatex(0.2,0.93,"#Delta_2H00.XPOS");
  t2->SetTextColor(kRed);
  t2->Draw();

  TLatex *t4 = new TLatex(0.35,0.93,"#Delta_2H02.XPOS");
